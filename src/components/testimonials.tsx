...
const testimonials = [
  {
    ...
    content:
      "I had Jared come give me a quote and then install a full security system in my home, he has done a fantastic job and I had a few little teething issues but he quickly had them sorted for me, I recommend Savvy Electrical and Data. Thank you so much for your hard work Jared!",
  },
  {
    name: "Narelle Brown",
    content:
  ...
  return (
    <>
      <Box width={{ base: "full", sm: "lg", lg: "xl" }} margin={"auto"}>
        ...
        >
          Check out why our clients recommend Savvy Electrical and Data for your
          project!
        </Center>
      </Box>
      <SimpleGrid
